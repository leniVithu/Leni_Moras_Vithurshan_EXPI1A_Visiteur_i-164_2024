...
class FormWTFAjouterGenres(FlaskForm):
    ...
    nom_genre_wtf = StringField("Nom du visiteur ", validators=[Length(min=2, max=20, message="min 2 max 20"),
    ...
    prenom_genre_wtf = StringField("Prénom du visiteur ", validators=[Length(min=2, max=20, message="min 2 max 20"),
                                                                   Regexp(nom_genre_regexp,
                                                                          message="Pas de chiffres, de caractères "
                                                                                  "spéciaux, "
                                                                                  "d'espace à double, de double "
    ...
    adresse_genre_regexp = "^([A-Z]|[a-zÀ-ÖØ-öø-ÿ])[A-Za-zÀ-ÖØ-öø-ÿ]*['\- ]?[A-Za-zÀ-ÖØ-öø-ÿ]+$"
    adresse_genre_wtf = StringField("Adresse du visiteur ", validators=[Length(min=2, max=50, message="min 2 max 50"),
                                                                   Regexp(nom_genre_regexp,
                                                                          message="Pas de chiffres, de caractères "
                                                                                  "spéciaux, "
                                                                                  "d'espace à double, de double "
    ...
    datenaiss_genre_wtf = StringField("Date de naissance du visiteur ", validators=[Length(min=2, max=20, message="min 2 max 20"),
                                                                   Regexp(nom_genre_regexp,
    ...
    telephone_genre_wtf = StringField("Numéro de téléphone du visiteur ", validators=[Length(min=2, max=30, message="min 2 max 30"),
                                                                   Regexp(nom_genre_regexp,
    ...
    idsociete_genre_wtf = StringField("Société du visiteur ", validators=[Length(min=2, max=20, message="min 2 max 20"),
                                                                   Regexp(nom_genre_regexp,
    ...
    vehicule_genre_wtf = StringField("Est-ce que le visiteur vient en véhicule? ", validators=[Length(min=2, max=20, message="min 2 max 20"),
                                                                   Regexp(nom_genre_regexp,
